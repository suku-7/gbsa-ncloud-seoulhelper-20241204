...
CLOVA_API_KEY = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
CLOVA_API_KEY_PRIMARY_VAL = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
CLOVA_REQUEST_ID = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
...
with col2:
  ...
  def search_blog(query, display=4):
    ...
    headers = {
        "X-Naver-Client-Id": "aaaaaaaaaaaaaaaaaaaa",
        "X-Naver-Client-Secret": 'aaaaaaaaaa'
    }
